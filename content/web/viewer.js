...
(function rewriteUrlClosure() {
  ...
  _app.PDFViewerApplication.initialBookmark = location.hash.slice(1);
})();
const ChromeCom = {
...
const PDFViewerApplication = {
  ...
  async _initializeViewerComponents() {
    ...
    if (appConfig.annotationEditorParams) {
      if (annotationEditorMode !== _pdfjsLib.AnnotationEditorType.DISABLE) {
        ...
        const editorStampButton = (_appConfig$toolbar = appConfig.toolbar) === null || _appConfig$toolbar === void 0 ? void 0 : _appConfig$toolbar.editorStampButton;
  ...
  async run(config) {
    ...
    if (!this.supportsPrinting) {
      var _appConfig$toolbar2, _appConfig$toolbar2$p, _appConfig$secondaryT3;
      (_appConfig$toolbar2 = appConfig.toolbar) === null || _appConfig$toolbar2 === void 0 ? void 0 : (_appConfig$toolbar2$p = _appConfig$toolbar2.print) === null || _appConfig$toolbar2$p === void 0 ? void 0 : _appConfig$toolbar2$p.classList.add("hidden");
    ...
    if (this.supportsIntegratedFind) {
      var _appConfig$toolbar3, _appConfig$toolbar3$v;
      (_appConfig$toolbar3 = appConfig.toolbar) === null || _appConfig$toolbar3 === void 0 ? void 0 : (_appConfig$toolbar3$v = _appConfig$toolbar3.viewFind) === null || _appConfig$toolbar3$v === void 0 ? void 0 : _appConfig$toolbar3$v.classList.add("hidden");
    }
  ...
  async _initializeMetadata(pdfDocument) {
    ...
    if (pdfTitle) {
      ...
      this.setTitle(`${this._contentDispositionFilename || this._title}`);  // mn297
...
function webViewerTouchMove(evt) {
  ...
  if (supportsPinchToZoom) {
    ...
    const PIXELS_PER_LINE_SCALE = 30;
    // const PIXELS_PER_LINE_SCALE = 1; // mn297
...
function webViewerClick(evt) {
  var _PDFViewerApplication21, _appConfig$toolbar4, _appConfig$secondaryT5;
...
class PDFScriptingManager {
  ...
  async setDocument(pdfDocument) {
    ...
    this._internalEvents.set("dispatcheventinsandbox", event => {
      var _this$scripting;
      (_this$scripting = this.#scripting) === null || _this$scripting === void 0 ? void 0 : _this$scripting.dispatchEventInSandbox(event.detail);
    });
    ...
    this._internalEvents.set("pagesdestroy", async () => {
      var _this$scripting2, _this$closeCapability;
      await this.#dispatchPageClose(this.#pdfViewer.currentPageNumber);
      await ((_this$scripting2 = this.#scripting) === null || _this$scripting2 === void 0 ? void 0 : _this$scripting2.dispatchEventInSandbox({
        id: "doc",
        name: "WillClose"
      }));
      (_this$closeCapability = this.#closeCapability) === null || _this$closeCapability === void 0 ? void 0 : _this$closeCapability.resolve();
    });
    ...
    await ((_this$scripting3 = this.#scripting) === null || _this$scripting3 === void 0 ? void 0 : _this$scripting3.dispatchEventInSandbox({
      id: "doc",
      name: "Open"
    }));
  ...
  async dispatchWillSave() {
    var _this$scripting4;
    return (_this$scripting4 = this.#scripting) === null || _this$scripting4 === void 0 ? void 0 : _this$scripting4.dispatchEventInSandbox({
      id: "doc",
      name: "WillSave"
    });
  }
  async dispatchDidSave() {
    var _this$scripting5;
    return (_this$scripting5 = this.#scripting) === null || _this$scripting5 === void 0 ? void 0 : _this$scripting5.dispatchEventInSandbox({
      id: "doc",
      name: "DidSave"
    });
  }
  async dispatchWillPrint() {
    var _this$scripting6;
    return (_this$scripting6 = this.#scripting) === null || _this$scripting6 === void 0 ? void 0 : _this$scripting6.dispatchEventInSandbox({
      id: "doc",
      name: "WillPrint"
    });
  }
  async dispatchDidPrint() {
    var _this$scripting7;
    return (_this$scripting7 = this.#scripting) === null || _this$scripting7 === void 0 ? void 0 : _this$scripting7.dispatchEventInSandbox({
      id: "doc",
      name: "DidPrint"
    });
  }
  get destroyPromise() {
    var _this$destroyCapabili;
    return ((_this$destroyCapabili = this.#destroyCapability) === null || _this$destroyCapabili === void 0 ? void 0 : _this$destroyCapabili.promise) || null;
  }
  get ready() {
    return this.#ready;
  }
  ...
  async #updateFromSandbox(detail) {
    ...
    for (const elementId of ids) {
      ...
      if (element) {
        ...
        var _this$pdfDocument;
        (_this$pdfDocument = this.#pdfDocument) === null || _this$pdfDocument === void 0 ? void 0 : _this$pdfDocument.annotationStorage.setValue(elementId, detail);
      }
    }
  }
  async #dispatchPageOpen(pageNumber) {
    ...
    const actionsPromise = (async () => {
      var _pageView$pdfPage, _this$scripting8;
      ...
      await ((_this$scripting8 = this.#scripting) === null || _this$scripting8 === void 0 ? void 0 : _this$scripting8.dispatchEventInSandbox({
        id: "page",
        name: "PageOpen",
        pageNumber,
        actions
  ...
  async #dispatchPageClose(pageNumber) {
    ...
    await ((_this$scripting9 = this.#scripting) === null || _this$scripting9 === void 0 ? void 0 : _this$scripting9.dispatchEventInSandbox({
      id: "page",
      name: "PageClose",
      pageNumber
    }));
  ...
  async #destroyScripting() {
    var _this$destroyCapabili3;
    if (!this.#scripting) {
      var _this$destroyCapabili2;
      this.#pdfDocument = null;
      (_this$destroyCapabili2 = this.#destroyCapability) === null || _this$destroyCapabili2 === void 0 ? void 0 : _this$destroyCapabili2.resolve();
      return;
    }
    if (this.#closeCapability) {
    ...
    this.#scripting = null;
    this.#ready = false;
    (_this$destroyCapabili3 = this.#destroyCapability) === null || _this$destroyCapabili3 === void 0 ? void 0 : _this$destroyCapabili3.resolve();
  }
}
...
var _app = __webpack_require__(2);
var _document$blockUnbloc, _document;
const pdfjsVersion = '3.9.49';
const pdfjsBuild = '47b6bbf5a';
